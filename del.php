...
<body>
    ...
    if (isset($_GET['delete'])) {
        ...
        if (isset($_SESSION['image_paths'][$index])) {
            ...
            $_SESSION['image_paths'] = array_values($_SESSION['image_paths']);
    ...
    <div class="container">
        <form action="" method="POST" enctype="multipart/form-data">
            ...
            <br><br>
            <input type="submit" value="Upload Images" class="btn btn-primary" name="submit">
        </form>
            ...
            <div class="container">
                <div class="row">
                    ...
                    foreach ($_SESSION['image_paths'] as $index => $image_path) {
                        ...
                        echo "<a href='?delete=$index' class='btn btn-danger'>Delete</a><br><br>";
                        echo "</div>";
                    }
                    ?>
                </div>
